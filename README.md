...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-nik61ti.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-nik61ti.containers.anotherwebservice.com/
...
```
git clone git@github.com:RuikeYuan/container-nik61ti.git
cd container-nik61ti
```
...
```
docker attach container-nik61ti
```
